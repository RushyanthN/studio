    ...
    <section id="home" className="h-screen flex items-center justify-center text-center relative">
      <div className="z-10">
        ...
        <p className="text-xl md:text-2xl text-gray-300 mb-2">
          AIML Engineer | Data Scientist & ML Engineer | 3+ Years Experience | AWS Certified
        </p>
        <p className="text-lg text-gray-400 mb-8 max-w-3xl mx-auto">
          Building predictive models, automating data pipelines, and deploying production-scale ML systems. 
